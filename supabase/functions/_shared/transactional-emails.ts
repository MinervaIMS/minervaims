    ...
    <tr>
      <td align="center" style="padding:32px 16px;">
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px;max-width:600px;background:#FFFFFF;border:1px solid #E0E0E0;">
          ...
          <tr><td style="padding:0 40px;"><p style="margin:0 0 18px;font-family:Calibri,'Segoe UI',Helvetica,Arial,sans-serif;font-size:15px;line-height:1.75;color:#141414;">Please note that this reassignment can happen only once during the selection process and cannot be undone.</p></td></tr>
          ...
          <tr>
            <td style="padding:0 40px 18px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #E0E0E0;">
                ...
                <tr><td style="padding:14px 18px;font-family:Calibri,'Segoe UI',Helvetica,Arial,sans-serif;font-size:14px;line-height:1.5;color:#141414;"><span style="color:#737373;letter-spacing:.04em;text-transform:uppercase;font-size:11px;font-weight:700;">Meeting link</span><br /><span style="color:#737373;">A member of the association will share the meeting link before the interview.</span></td></tr>
              </table>
            </td>
          </tr>
          <tr><td style="padding:6px 40px 2px;"><p style="margin:0 0 10px;font-family:Calibri,'Segoe UI',Helvetica,Arial,sans-serif;font-size:12px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#1F0F4D;">How to prepare</p></td></tr>
