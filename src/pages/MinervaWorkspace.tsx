...
const MinervaWorkspace = () => {
  ...
  // Mobile shell: same navigation data and the same content renderer, laid
  // out for a small screen. The desktop layout below stays untouched.
  if (!isDesktop) {
    return (
      <>
        <Helmet>
