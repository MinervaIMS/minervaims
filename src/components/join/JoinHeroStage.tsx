...
export function JoinHeroStage({ figures }: { figures: ReactNode }) {
  ...
  return (
    ...
    >
      ...
      */}
      <div className="container relative z-10 pb-12 pt-[calc(84px+env(safe-area-inset-top)+theme(spacing.10))] md:pb-14 md:pt-[calc(84px+env(safe-area-inset-top)+theme(spacing.14))]">
