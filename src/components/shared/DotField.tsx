...
// =====================================================================
// DotField — an interactive dotted background (React Bits), adapted to the
// Minerva palette. A field of small dots painted with a purple gradient that
// gently "bulges" away from the cursor. Used as the full-bleed background of the
// application flow (Apply form, post-application check-email, success card).
// Colours default to Minerva's deep-indigo / lavender accent family.
// =====================================================================
...
export interface DotFieldProps {
  ...
  /** Dot gradient start (Minerva mid-purple by default). */
  gradientFrom?: string;
  /** Dot gradient end (Minerva lavender by default). */
  gradientTo?: string;
...
const DotField = memo(function DotField({
  ...
  sparkle = false,
  waveAmplitude = 0,
  // Minerva accent family: deep indigo (#1F0F4D) → lavender (#A99ED6).
  gradientFrom = '#7E5BC2',
  gradientTo = '#B0A2DA',
  glowColor = '#2A1A5C',
  className,
