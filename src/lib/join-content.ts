...
export const JOIN_WRITTEN = {
  ...
  lead: 'Answer the written question for your first-choice division. Maximum one page, plus an Appendix of up to two pages for any charts and tables. Minimum 10pt font.',
  divisions: [
