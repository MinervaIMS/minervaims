...
export const DEFAULT_MATRIX: Partial<Record<AppRole, RoleGrants>> = {
  ...
  analyst: { 'my-role': 'manage', 'dashboard': 'view', 'welcome': 'view', 'calendar': 'view', 'reports-archive': 'view', 'reports-templates': 'view', 'events-on-display': 'view', 'people-members': 'view', 'people-alumni': 'view' },
