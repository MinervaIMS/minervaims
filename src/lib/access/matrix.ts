...
export const DEFAULT_MATRIX: Partial<Record<AppRole, RoleGrants>> = {
  ...
  media_analyst: { 'my-role': 'manage', 'dashboard': 'view', 'welcome': 'view', 'calendar': 'view', 'events-on-display': 'view', 'smm-editorial': 'view', 'smm-ig': 'manage', 'smm-li': 'manage', 'smm-other': 'manage', 'smm-brand': 'view', 'smm-ads': 'view' },
