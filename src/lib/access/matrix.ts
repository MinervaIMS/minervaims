...
export const DEFAULT_MATRIX: Partial<Record<AppRole, RoleGrants>> = {
  ...
  senior_analyst: { 'my-role': 'manage', 'dashboard': 'view', 'welcome': 'view', 'calendar': 'view', 'reports-archive': 'view', 'reports-templates': 'manage', 'events-on-display': 'view', 'people-members': 'view', 'people-invites': 'view', 'people-alumni': 'view', 'website-readings': 'view' },
  analyst: { 'my-role': 'manage', 'dashboard': 'view', 'welcome': 'view', 'calendar': 'view', 'reports-archive': 'view', 'reports-templates': 'view', 'events-on-display': 'view', 'people-members': 'view', 'people-invites': 'view', 'people-alumni': 'view', 'website-readings': 'view' },
...
// People > Members: these roles open the register in view-only mode limited
// to the people of their OWN division (name lists, search and filters only).
// Managing roles, heads and advisors see the whole register. The database
// enforces the same limit through row-level security.
export const MEMBERS_DIVISION_VIEW_ROLES: AppRole[] = [
  'portfolio_manager', 'team_leader', 'senior_analyst', 'analyst',
];
