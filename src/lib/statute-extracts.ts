...
export const roleGuides: Partial<Record<AppRole, RoleGuide>> = {
  ...
  vice_president: {
    ...
    responsibilities: [
      ...
      'Verify that the membership-fee collection has been completed and intervene in cases of non-payment.',
      'Share oversight of Association on Display and of admissions fairness.',
    ],
    reportsTo: 'The President.',
    oversees: ['Heads of Division', 'Head of Operations', 'Head of Media & Communication'],
    rights: ['Act for the President when delegated.', 'Review admissions where fairness is in doubt.'],
  ...
  portfolio_manager: {
    ...
    responsibilities: [
      'Monitor the fund, take investment decisions and produce periodic fund reports.',
    ...
    rights: ['Manage the assigned fund within the agreed mandate.'],
  ...
  head_of_operations: {
    ...
    responsibilities: [
      ...
      'Handle room bookings and institutional event requests through Bocconi/CASA channels.',
      'Maintain the members register and administrative records.',
