...
export const GUIDE: GuideEntry[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'priority', title: 'Priority', body: 'A marker for the candidates to be looked at first. It is off for everybody until somebody turns it on, from inside the candidate\u2019s own window, and it then shows as a red mark in its own column beside the LinkedIn one, for every reviewer. It changes nothing else: no status moves, nothing is sent and the candidate is never told. Setting it is reserved for the roles that manage this page, the President, the Vice President, the Head of Asset Management and the Heads of Division, for any candidate they can see, including one another division is assessing.' },
